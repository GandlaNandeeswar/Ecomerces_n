...
urlpatterns = [
    ...
    # Admin portal pages (custom UI, separate from Django /admin/)
    path("admin-portal/login/", views.admin_login_page, name="admin_login"),
    path("admin-portal/", views.admin_dashboard_page, name="admin_dashboard"),
    path("admin-portal/database/", views.admin_database_page, name="admin_database"),
    ...
    path("api/admin/database/", views.api_admin_database, name="api_admin_database"),
